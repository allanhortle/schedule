...
const Viewer = proxyquire('../Viewer', {
    'schedule/EntityQuery': proxyquire('../../entity/EntityQuery', {
        'schedule/util/request': function() {return Promise.resolve()}
    }).default
}).default;

process.env.SCHEDULE_GRAPHQL_SERVER = 'http://localhost:3000';
